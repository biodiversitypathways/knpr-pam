...
-   Define straightforward methods for evaluating abundance, species richness and species diversity and trends over time to inform ecological integrity measures;
...
#| include: true
#| fig-align: center
#| tbl-cap: Comparison table of four scenarios 
...
results |>
  ...
  mutate(Scenario = case_when(
    Scenario == "Scenario_1" ~ "Abundance of 4 spp.",
  ...
  rename(`Mean difference` = "mean_diff") |>
  kable()
